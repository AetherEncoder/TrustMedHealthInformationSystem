...
Public Class frmDashboard
    ...
    Private Sub LoadDashboardOverview()
        Try
            ...
            Dim cmd As New MySqlCommand(userSQLQuery, CType(MyConnection, MySqlConnection))
            Dim patientCount As Object = cmd.ExecuteScalar()
            If patientCount IsNot Nothing AndAlso Not IsDBNull(patientCount) Then
                lblTotalPatient.Text = Convert.ToInt32(patientCount).ToString()
            Else
            ...
            Dim labOrderCount As Object = cmd.ExecuteScalar()
            If labOrderCount IsNot Nothing AndAlso Not IsDBNull(labOrderCount) Then
                lblLabOrdersValue.Text = Convert.ToInt32(labOrderCount).ToString()
            Else
